...
def objective(trial):
		...
		Vmax=trial.suggest_uniform('vmax', 1.1, 2)
		tau_post=trial.suggest_int('tau_post', 1, 701, step=50) 
		...
		"Vth:", Vth, "beta:", beta, "tau_syn:", tau_syn, "Vmax:", Vmax)
		...
		return total_acc/len(train_data)
